...
function ChatBotComponent() {
    ...
    return (
        <div style={{bottom:"20px",right:"20px",position:"fixed",zIndex:"999"}}>
...
steps={[
    ...
    },
    {
      id: '2',
      options: [
        { value: 1, label: 'Ministry of Health and Family Welfare helpline', trigger: '3' },
    ...
    {
      id: '3',
      message: 'The number is 1075. Do you want to continue using the Bot?',
      trigger: '6',
    },
    {
      id: '4',
      message: 'The number is 0471-2309251. Do you want to continue using the Bot?',
      trigger: '6',
    }, 
    {
        id: '5',
        message: 'The number is 1056. Do you want to continue using the Bot?',
        trigger: '6',
      },
      {
        id: '6',
